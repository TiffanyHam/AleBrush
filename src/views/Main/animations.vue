...
<template>
    <div class="brushing_other flexC">
        ...
        <div class="subheader">请按顺序清洁每个牙面</div>
        <!-- 音乐图标 -->
        <span
            @touchstart="movestart($event)"
            @touchend="movend($event)"
            @touchmove="move($event)"
            :style="{left: bindX,top: bindY}"
            :class=" open ? 'img bg' : 'img bg img_close' "
            ref="img"
        ></span>
        <!-- 刷牙引导 -->
        <div class="banner flex">
            <div class="centerImg posiImg position_center">
                ...
                <!-- 右下 -->
                <div v-if="6 == index" class="right_down_out posiImg animate opcity_animate"></div>
                ...
                <!-- 右上 -->
                <div v-if="9 == index" class="right_up_out posiImg animate opcity_animate"></div>
                ...
                <!-- 左上 -->
                <div v-if="14 == index" class="left_up_out posiImg animate opcity_animate"></div>
...
.brushing_other {
    ...
    .img {
        ...
        background-image: url("../../assets/image/cut_surface/music_on.png");
    }
    .img_close {
        background-image: url("../../assets/image/cut_surface/music_close.png");
    }
    .banner {
        width: 100%;
        flex: 1;
