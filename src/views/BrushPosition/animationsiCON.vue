    ...
    <div class="brushing_other flexC">
        ...
        <div class="banner flex">
            <div class="centerImg posiImg position_center">
                ...
                <div v-if="index == 1" class="currentA currrent_bottom"><span class="fingle fingle_left"></span>当前区域</div>
                ...
                <div v-if="index == 2" class="currentA currrent_bottom">当前区域<span class="fingle fingle_right"></span></div>
                ...
                <div v-if="index == 3" class="currentA currrent_top">当前区域<span class="fingle fingle_right1"></span></div>
                ...
                <div v-if="index == 4" class="currentA currrent_top"><span class="fingle fingle_left1"></span>当前区域</div>
                <div v-if="index == 0">
